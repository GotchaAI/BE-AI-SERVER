...
class LuLuAI:
    ...
    def generate_drawing_task(self, game_id: str) -> Dict:
        ...
        try:
            ...
            raise RuntimeError(f"Error generating drawing task: {e}") # 상위에서 처리하도록 예외 던짐, todo: 전역 핸들러 추가
    ...
    def evaluate_drawing(self, game_id: str, drawing_description: str) -> Dict:
        ...
        try:
            ...
            raise RuntimeError(f"Error evaluating drawing: {e}") # 상위에서 처리하도록 예외 던짐, todo: 전역 핸들러 추가